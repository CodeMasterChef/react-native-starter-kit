                    ...
                    >
                        {
                            ...
                            <MaterialCommunityIcons name='close-circle-outline' size={46} color='#fff' />
                        }
                        {
                            !!(this.props.showCheckIcon) &&
                            <MaterialCommunityIcons name='checkbox-marked-circle-outline' size={46} color='#fff' />
                        }
                        {
                            !!(this.props.showWarningIcon) &&
                            <MaterialCommunityIcons name='information-outline' size={46} color='#fff' />
                        }
